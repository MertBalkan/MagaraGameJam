...
namespace MagaraGameJam.Concretes.Movements
{
    public class FlipWithTransform : IFlip
    {
        ...
        public void Flip(float direction)
        {
            ...
            Vector2 newFlipVector = direction > 0 ? flipVector = new Vector2(direction + 4, _entity.transform.localScale.y) : flipVector = new Vector2(direction - 4, _entity.transform.localScale.y);
